...
(function() {
  ...
  exports.cssCompilers = cssCompilers = {
    styl: {
      ...
      plugins: [],
      use: function(fn) {
        return this.plugins.push(fn);
      },
      compileSync: function(sourcePath, source) {
        var callback, options, plugin, renderer, result, _base, _i, _len, _ref, _ref1;
        result = '';
        ...
        renderer = libs.stylus(source, options).use(libs.bootstrap()).use(libs.nib()).use(libs.bootstrap()).set('compress', this.compress).set('include css', true);
        console.log("Using stylus plugins", this.plugins);
        _ref1 = this.plugins;
